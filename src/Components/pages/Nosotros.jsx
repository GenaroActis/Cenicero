...
const nosotros = () => {
    return (
        ...
        <div id='nosotros'>
            ...
            <Link target="_self" rel="noreferrer" className="nav-link px-2 text-white" aria-current="page" to={`/products`}>
                <img  src="https://res.cloudinary.com/dsdicaf5h/image/upload/v1674159144/cenicero/footer_nozkhv.png" alt="description image" className='img-fluid' id='imgNosotros' />
            </Link>
        </div>
        <ToastContainer/>
        </>
